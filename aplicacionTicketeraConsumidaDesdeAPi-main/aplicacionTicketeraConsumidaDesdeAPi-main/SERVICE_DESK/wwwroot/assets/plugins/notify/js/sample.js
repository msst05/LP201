...
function notActualizarEstado() {
    notif({
        msg: "<b>Listo:</b> Estado actualizado correctamente.",
        type: "success"
    });
}

function notActualizarEstadoError() {
    notif({
        msg: "<b>Oops!</b> Ocurrio un error al actualizar el estado.",
        type: "error"
    });
}

function notActualizarContrasena() {
    notif({
        msg: "<b>Listo:</b> Password actualizada correctamente.",
        type: "success"
    });
}

function notActualizarContrasenaError(error) {
    notif({
        msg: error,
        type: "error"
    });
